...
CATALOG = [
    {
        ...
        "normal": "即使在下层，每个白天也可打断一次他人发言；每夜可寻宝。只要仍存活，同席另一张牌及相邻席当前牌中毒。前两天不能魔女化；第三天若仍存活则必定魔女化。",
        "witch": "夜里可杀死所有其他角色。",
    },
    {
        "id": "hiro",
        ...
        "normal": "即将死亡时自动回溯一次：夜间回到前一天顺序发言，白天回到前一天自由发言；找不到该时点则回到开局。保留记忆与普通技能，精神系效果不恢复。",
    ...
    },
    {
        ...
        "normal": "始终位于每份疑似凶手名单中，使名单由三人增加为四人；13水致死同样出现。",
    ...
    },
    {
        ...
        "normal": "每晚可庇护一张当前牌：死亡改为负伤，再次受到普通伤害则出局。",
    ...
    },
    {
        ...
        "normal": "每晚必须交换一名玩家，该目标一直保留到你下一次交换。其普通死亡（不含处刑、质疑失败与殉情）由你代替。",
    ...
    },
    {
        ...
        "normal": "白天可宣布爱上一人或移情；若爱人整席出局则转爱自己。每夜令爱人席当前牌负伤一次，已有负伤不会因此死亡。",
        "witch": "普通安安真实洗脑时学会洗脑；两人同时洗脑互相抵消。",
    },
    {
        "id": "leia",
        "name": "蕾雅",
        "avatar": "/assets/characters/莲见蕾雅.png",
        "normal": "每个白天一次，以长矛令一张当前牌立即进入标准出局预结算；自己同时加入本日处决名单。",
        "witch": "无额外魔女技能。",
    },
    {
        "id": "honoka",
