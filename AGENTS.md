...
- 米莉亚临死换牌与热气球组织都没有主持人判定点：米莉亚的预结算一旦会出局就直接换上层牌重算；热气球由亚里沙直接定名单（含她自己至多5人），她不在场时改为玩家提议、超过半数存活玩家同意即自动组织。
- 米莉亚临死换牌、热气球组织（亚里沙定名单或玩家提议后过半同意）都没有主持人判定点，选好即自动结算；不明确的概率和规则交由主持人裁决，保留显式确认与30秒警告。系统自己知道做完的阶段（魔女化、夜间行动、顺序发言、热气球、提名、投票、处决前响应）无人待办时5秒后自动推进，主持人可暂停或手动推进；需要主持人判断或宣布的阶段仍由主持人推进。
